...
"number"===typeof v&&(Infinity===v||/^[0-9]+$/.test(v.toString()))&&W("checkInterval",1E3*v);n._aliasHostHeader&&W("aliasHostHeader",n._aliasHostHeader);f.version||(f.version="suki.js_v11.0.18");"port"===x&&(ca.listen(w,n.bind||"::"),ca.parse=oa,f.log(f.dateFormat(new Date)+" UTC\ndeno_v"+Deno.version.deno.replace("v","")+"\n"+f.version+" Javascript Application Server (HTTP listening on "+(n.bind||"::")+":"+w+")  \r\n"));return q}}function q(n){n(f)}function t(n){function w(G){var C="",r="",u="undefined"===
